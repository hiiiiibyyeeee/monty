...
client.login("ODk3Mjg5MzI5MjMwMTEwNzcw.YWTfzg.y5lVQv4ZkXnX1qg7LbTygC5rbBo");
...
client.on("guildCreate", guild => {
  let channel = client.channels.cache.get("888547312320806912");
...
////////
   ...
   ///////////////////////////////
    ...
    client.user.setActivity(`Servers ${client.guilds.cache.size} / Users ${client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)},`, { type: "PLAYING"});
